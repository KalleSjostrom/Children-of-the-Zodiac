 ...
 */
public class SpiritAssault extends Card {
	...
	public ParticleSystemPacket getAnimation(AnimationInfo info) {
		...
		return SpiritAssault.getStaticAnimation(info);
	}
	...
	public static ParticleSystemPacket getStaticAnimation(AnimationInfo info) {
		...
		settings.setVector(AnimSettings.SOURCE, new Vector3f(-size, -.4f, -4));
		settings.setVector(AnimSettings.TARGET, new Vector3f(size, .4f, -4));
