...
public class Death extends Card {
	...
	public ParticleSystemPacket getAnimation(AnimationInfo info) {
		return Death.getStaticAnimation(info);
	}
	...
	public static ParticleSystemPacket getStaticAnimation(AnimationInfo info) {
		...
		settings.setValue(AnimSettings.SIZE, .7f);
		...
		settings.setValue(AnimSettings.NR_TEXTURES + 2, ParticleSystem.DEATH_1);
		settings.setValue(AnimSettings.NR_TEXTURES + 3, ParticleSystem.DEATH_2);
