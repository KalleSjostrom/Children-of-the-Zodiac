...
public class SerphiaDeath extends Card {
	...
	public ParticleSystemPacket getAnimation(AnimationInfo info) {
		return SerphiaDeath.getStaticAnimation(info);
	}

	public static ParticleSystemPacket getStaticAnimation(AnimationInfo info) {
		ParticleSystemPacket psp = new ParticleSystemPacket(false);
		...
		settings.setValue(AnimSettings.NR_PARTICLES, 4);
		...
		CircularWave wave = new CircularWave(period, .5f, 0, false, true, -6);
		...
		settings.setValue(AnimSettings.NR_TEXTURES + 1, ParticleSystem.DEATH_1);
		wave = new CircularWave(period, .5f, (float) Math.PI / 2, false, true, -6);
		settings.setVectorEquation(AnimSettings.POSITION_VECTOR_EQUATION, wave);
		psp.add(new ParticleSystem(settings), 0);
		
		settings.setValue(AnimSettings.NR_TEXTURES + 1, ParticleSystem.DEATH_0);
		wave = new CircularWave(period, .5f, (float) Math.PI, false, true, -6);
		settings.setVectorEquation(AnimSettings.POSITION_VECTOR_EQUATION, wave);
		psp.add(new ParticleSystem(settings), 0);
		
		settings.setValue(AnimSettings.NR_TEXTURES + 1, ParticleSystem.DEATH_2);
		wave = new CircularWave(period, .5f, (float) (3 * Math.PI / 2f), false, true, -6);
		settings.setVectorEquation(AnimSettings.POSITION_VECTOR_EQUATION, wave);
		psp.add(new ParticleSystem(settings), 0);
